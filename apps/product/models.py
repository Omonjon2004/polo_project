...
from apps.product.choices import (Bags_Category_List, Dress_Brand_List,
                                  Dress_Category_List, Dress_size_List,
                                  Electrical_Brand_List,
                                  Electrical_Category_list, Jackets_Brand_List,
                                  Jackets_Category_list, Jewelry_Brand_List,
                                  Jewelry_Category_List, Shoes_Brand_List,
                                  Shoes_Category_List, Shoes_size_List)
...
class Shoes(BaseProduct):
    brand = models.CharField(
        max_length=100, choices=Shoes_Brand_List, blank=True, null=True
    )
    ##brendi yuq bo'lishi ham mumkin blank true shunga
...
class Dress(BaseProduct):
    brand = models.CharField(
        max_length=100, choices=Dress_Brand_List, blank=True, null=True
    )
    ##brendi yuq bo'lishi ham mumkin blank true shunga
...
class Jewelry(BaseProduct):
    brand = models.CharField(
        max_length=50, choices=Jewelry_Brand_List, blank=True, null=True
    )
    ##brendi yuq bo'lishi ham mumkin blank true shunga
    ...
    )  # probasi uchun uzuklarni


class Jackets(BaseProduct):
    brand = models.CharField(
        max_length=50, choices=Jackets_Brand_List, blank=True, null=True
    )
    ##brendi yuq bo'lishi ham mumkin blank true shunga
